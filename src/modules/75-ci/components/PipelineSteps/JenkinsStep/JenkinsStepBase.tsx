...
import type { JenkinsStepProps, JenkinsStepData, JenkinsStepDataUI } from './JenkinsStep'
...
export const JenkinsStepBase = (
  { initialValues, onUpdate, isNewStep = true, readonly, stepViewType, onChange }: JenkinsStepProps,
  ...
  // TODO: Right now we do not support Image Pull Policy but will do in the future
  // const values = getInitialValuesInCorrectFormat<JenkinsStepData, JenkinsStepDataUI>(initialValues, transformValuesFieldsConfig, {
  //   pullOptions
  // })
